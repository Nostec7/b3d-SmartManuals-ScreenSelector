...
export const fullDataJSON = [
  ...
  },
  {
    ...
    "section": "",
    "tags": ["Jet Pump Controls", "Media Screen"],
    "type": "interactiveP3DModel",
    "interactiveP3DModel": {
      "type": "screenController",
      "p3dID": "",
      ...
      },
      {
        ...
        "anchors": [
          ...
          },
          {
            ...
            "actionMsg": {
              "notificationOnly": true,
              "message": "Volume increased. Maximum volue is 30."
            },
            "targetImage": {
              "direction": "forward",
              "urls": 
          ...
          },
          {
            ...
            "actionMsg": {
              "notificationOnly": true,
              "message": "Volume decreased. Minimum volue is 0."
            },
            "targetImage": {
              "direction": "backwards",
              "urls": 
        ...
        },
        {
          ...
          "anchors": [
            ...
            },
            {
              ...
              "actionMsg": {
                "notificationOnly": true,
                "message": "Decreasing light intensity. Maximum is <b>5</b>"
              },
              "targetImage": {
                "direction": "forward",
                "urls": 
